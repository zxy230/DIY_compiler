...
)
{
   int /*comment*/ result = 1 /*Initial value
       ...
       ;
   if /*comment*/ (n <= /*comment*/ 0) /*comment*/
   {
      return /*comment*/ 1 /*Base case
                            * for factorial*/
          ;
   }
   else /*comment*/
   {
      while /*nested*/ (n /*comment*/ > /*gt*/ 1 /*comment*/)
      {
         result = result * /*multiply*/ n;
         n = n - /*decrement*/ 1 /*not using ++ as specified*/;
      }
      return /*
/*
//
    ...
    )
{
   ...
   else if (x < y || /*logical or*/ x == y)
   {
      z = factorial(-(x /*addition*/ + y));
   }
   else
   {
      z = factorial(x * /*multiplication*/ y);
   }
   while /*(1+1==2)*/ (z > 100)
   {
      if (z % /*%*/ 2 == 0)
